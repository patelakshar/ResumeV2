...
const navLinks = [
  ...
  { path: '/find-jobs', label: 'Find Jobs', icon: 'finder' },
...
function NavIcon({ icon }) {
  const icons = {
    ...
    finder: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16a4 4 0 108 0 4 4 0 00-8 0zm0 0c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4zm12-6a4 4 0 10-8 0 4 4 0 008 0z" />,
...
function Navbar() {
  ...
  const getCurrentPageLabel = () => {
    ...
    if (path === '/find-jobs') return 'Find Jobs'
